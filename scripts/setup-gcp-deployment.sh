...
echo "🚀 L0181 GCP Deployment Setup"
echo "=============================="
...
if [ "$DEPLOY_NOW" = "y" ]; then
    ...
    if command -v docker &> /dev/null; then
        ...
        docker build -t gcr.io/$PROJECT_ID/l0181:initial .
        docker push gcr.io/$PROJECT_ID/l0181:initial

        # Deploy to Cloud Run
        gcloud run deploy l0181 \
            --image gcr.io/$PROJECT_ID/l0181:initial \
            --platform managed \
            --region us-central1 \
            --port 50181 \
