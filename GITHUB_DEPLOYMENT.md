...
5. Select your repository: `graffiticode/l0181`
6. Click "Connect"
...
2. Configure:
   - **Name**: `l0181-production-deploy`
   - **Description**: Deploy L0181 to production on main branch push
...
1. Click "Create Trigger"
2. Configure:
   - **Name**: `l0181-staging-deploy`
   - **Description**: Deploy L0181 staging on branch push
   - **Event**: Push to a branch
   - **Source**:
     - Repository: Your connected repo
...
```bash
PROJECT_ID=$(gcloud config get-value project)
GITHUB_REPO="graffiticode/l0181"
...
- URL: https://l0181-[hash]-uc.a.run.app
...
- URL: https://l0181-staging-[hash]-uc.a.run.app
- Full traffic routing
- Maximum instances: 10
- Memory: 256Mi

### Preview (feature branches)
- URL: https://l0181-[branch-name]-[hash]-uc.a.run.app
...
gcloud run services update-traffic l0181 \
  --to-revisions=l0181-00005-abc=100 \
  --region=us-central1
```
...
3. Verify port configuration (50181)
